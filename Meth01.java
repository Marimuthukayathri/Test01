...
public class Meth01 {
	...
	//*[@id="cdk-overlay-0"]/div/div/button[2]
	...
	public void PH_001() throws InterruptedException, IOException {
		...
		String columnvalue = sheet.getRow(1).getCell(0).getStringCellValue();
					...
					//	String [] Headers = new String [columncount];
						List<String> Headers  = new ArrayList<String>();
					     ...
					     for (int j=1;j<rowcount;j++) {
				             Headers.add(sheet.getRow(j).getCell(0).getStringCellValue());  
				         //   System.out.println(Headers);  
				         }
				        
					     Set<String> s = new LinkedHashSet<String>(Headers);   	 
		...
		/*	boolean duplicate = false;
	 		...
	 		if (columnvalue.equals(sheet.getRow(i+1).getCell(0).getStringCellValue())) {  
		    
	 			duplicate = true;
		         
		         
	 			columnvalue= sheet.getRow(i+1).getCell(0).getStringCellValue();  */
